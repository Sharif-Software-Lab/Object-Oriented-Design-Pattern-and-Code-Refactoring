...
پترن‌های Strategy و State هر دو عضو دسته‌ی الگوهای رفتاری (Behavioral Patterns) هستند.

<div dir="rtl">
Strategy: این الگو به شما امکان می‌دهد که خانواده‌ای از الگوریتم‌ها را تعریف کرده و آن‌ها را به صورت قابل تعویض در برنامه استفاده کنید، به طوری که می‌توانید الگوریتم را در زمان اجرا انتخاب کنید.

State: این الگو به یک شیء اجازه می‌دهد که رفتار خود را زمانی که وضعیت داخلی‌اش تغییر می‌کند، تغییر دهد؛ به عبارت دیگر، شیء به نظر می‌رسد که کلاس خود را تغییر داده است.
</div>
